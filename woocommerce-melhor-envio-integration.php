        ...
        public function init()
        {
            ...
            if(class_exists('WC_Integration') && class_exists('Extra_Checkout_Fields_For_Brazil')){
                ...
                function wpmelhorenvio_addMenu(){
                    add_menu_page("Melhor Envio", "Melhor Envio", "shop_manager", "wpmelhorenvio_melhor-envio",null, plugin_dir_url( __FILE__ )."mo.png");
                    add_submenu_page("wpmelhorenvio_melhor-envio","Melhor Envio - Meus dados", "Meus dados", "shop_manager", "wpmelhorenvio_melhor-envio", "wpmelhorenvio_pedidos");
                    add_submenu_page("wpmelhorenvio_melhor-envio","Melhor Envio - Pedidos", "Pedidos", "shop_manager", "wpmelhorenvio_melhor-envio-dados", "wpmelhorenvio_dados");
                    add_submenu_page("wpmelhorenvio_melhor-envio","Melhor Envio - Configurações do Plugin", "Configurações", "shop_manager", "wpmelhorenvio_melhor-envio-config", "wpmelhorenvio_config");
                    add_submenu_page("wpmelhorenvio_melhor-envio","Melhor Envio - Configurações da Conta", "Sua Conta Melhor Envio", "shop_manager", "wpmelhorenvio_melhor-envio-subscription", "wpmelhorenvio_cadastro");
                }
